...
export const EVENTS_DATA: EventShowcase[] = [
  ...
  },
  {
    ...
    color: "#D6E8F7",
    detailsLink: "/rules/prompt-wars",
    width: 175,
    height: 175,
    tags: ["AI Prompting", "Creative", "Precision", "Individual"],
    badgeColor: "#4A8FD4",
    badgeIcon: "/pokemons/leaf.png",
    badgeIconAlt: "Leaf",
    imageBg: "#D6E8F747",
    showcaseTags: [
      { label: "AI Prompting", bg: "#FFD9C3", border: "#FBB993" },
      { label: "Creative", bg: "#E6DBED", border: "#CCB8E6" },
      { label: "Precision", bg: "#CEF2FF", border: "#A6E0F4" },
      { label: "Individual", bg: "#D6EBDC", border: "#ADD6B8" },
    ],
  },
  {
    name: "CODING RELAY",
