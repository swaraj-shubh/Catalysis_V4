...
export default function AboutPage() {
  return (
    <div className="bg-[#FDE8EC] font-nunito text-[#1A0A0E] overflow-x-hidden">
      ...
      {/* ── HERO ── */}
      <section className="bg-[#DD273E] pt-20 pb-16 px-6 md:px-12 relative overflow-hidden border-b-4 border-[#1A0A0E]">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          <div className="inline-block bg-[#FCC803] text-[#1A0A0E] font-black text-xs tracking-[2px] px-5 py-1.5 rounded-full border-2 border-[#1A0A0E] mb-7 uppercase">
            About the club
          </div>
          
          <h1 className="font-gliker text-[72px] md:text-[120px] text-white leading-[0.9] tracking-[4px]" style={{ textShadow: '6px 6px 0 #1A0A0E' }}>
            Meet<br /><span className="text-[#FCC803]">Genesis.</span>
          </h1>
      ...
      {/* ── STATS BAND ── */}
      <div className="bg-[#FCC803] border-b-4 border-[#1A0A0E] overflow-hidden">
        <div className="flex animate-marquee-slow w-max">
          ...
          <div className="flex items-center justify-center border-r-4 border-[#1A0A0E] px-6">
             <div className="w-2.5 h-2.5 bg-[#DD273E] rounded-full border-2 border-[#1A0A0E]"></div>
          </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 border-b-4 border-[#1A0A0E]">
        <div className="px-6 py-12 md:p-14 lg:p-16 bg-white border-b-4 md:border-b-0 md:border-r-4 border-[#1A0A0E]">
          <div className="font-black text-[11px] tracking-[3px] uppercase text-[#DD273E] mb-4 flex items-center gap-2">
            <span className="block w-6 h-[3px] bg-[#DD273E] rounded-sm"></span>
            Our story
          </div>
          <h2 className="font-gliker text-5xl md:text-[56px] leading-none tracking-[3px] text-[#1A0A0E] mb-7">
            Born to <span className="text-[#DD273E]">Build</span> Things.
          </h2>
        ...
        <div className="bg-[#DD273E] flex flex-col justify-center items-center p-12 md:p-14 relative overflow-hidden gap-6">
          ...
          <div className="bg-[#FCC803] border-4 border-[#1A0A0E] rounded-2xl py-5 px-9 text-center shadow-[5px_5px_0_#1A0A0E] -rotate-3 relative z-10">
          ...
          <div className="flex flex-col gap-3 relative z-10 mt-4">
            <div className="bg-white border-4 border-[#1A0A0E] rounded-full py-3 px-7 font-black text-[15px] tracking-[0.5px] flex items-center gap-2.5 shadow-[4px_4px_0_#1A0A0E] rotate-[1.5deg] hover:rotate-0 hover:-translate-y-1 hover:shadow-[6px_6px_0_#1A0A0E] transition-all cursor-default">
              <div className="w-3 h-3 rounded-full border-2 border-[#1A0A0E] bg-[#DD273E] shrink-0"></div>
              Build Fast, Learn Faster
            </div>
            <div className="bg-white border-4 border-[#1A0A0E] rounded-full py-3 px-7 font-black text-[15px] tracking-[0.5px] flex items-center gap-2.5 shadow-[4px_4px_0_#1A0A0E] -rotate-[1.5deg] hover:rotate-0 hover:-translate-y-1 hover:shadow-[6px_6px_0_#1A0A0E] transition-all cursor-default">
              <div className="w-3 h-3 rounded-full border-2 border-[#1A0A0E] bg-[#3065A6] shrink-0"></div>
              Ship Real Things
            </div>
            <div className="bg-white border-4 border-[#1A0A0E] rounded-full py-3 px-7 font-black text-[15px] tracking-[0.5px] flex items-center gap-2.5 shadow-[4px_4px_0_#1A0A0E] rotate-[1.5deg] hover:rotate-0 hover:-translate-y-1 hover:shadow-[6px_6px_0_#1A0A0E] transition-all cursor-default">
              <div className="w-3 h-3 rounded-full border-2 border-[#1A0A0E] bg-[#FCC803] shrink-0"></div>
              Grow Together
            </div>
            <div className="bg-white border-4 border-[#1A0A0E] rounded-full py-3 px-7 font-black text-[15px] tracking-[0.5px] flex items-center gap-2.5 shadow-[4px_4px_0_#1A0A0E] -rotate-[1.5deg] hover:rotate-0 hover:-translate-y-1 hover:shadow-[6px_6px_0_#1A0A0E] transition-all cursor-default">
              <div className="w-3 h-3 rounded-full border-2 border-[#1A0A0E] bg-[#DD273E] shrink-0"></div>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#FDE8EC] border-b-4 border-[#1A0A0E]">
        <h2 className="font-gliker text-[48px] md:text-[56px] tracking-[3px] text-center text-[#1A0A0E] mb-14">
          What We <span className="text-[#DD273E]">Stand For</span>
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[1100px] mx-auto">
          {/* Card 1 */}
          <div className="bg-[#FCC803] border-4 border-[#1A0A0E] rounded-2xl p-8 lg:p-10 shadow-[6px_6px_0_#1A0A0E] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[10px_10px_0_#1A0A0E] transition-all relative overflow-hidden group">
      ...
      <section className="bg-[#FDE8EC] py-20 px-6 md:px-12 border-b-4 border-[#1A0A0E]">
        ...
        <div className="max-w-[800px] mx-auto relative">
          <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-1 bg-[#DD273E] md:-translate-x-1/2"></div>
          
          {/* Timeline Item 1 */}
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 mb-12 items-start relative pl-12 md:pl-0">
            <div className="absolute left-[8px] top-[24px] md:static md:mt-7 w-6 h-6 bg-[#FCC803] border-[3px] border-[#1A0A0E] rounded-full shrink-0 shadow-[0_0_0_4px_#DD273E] z-10"></div>
            <div className="flex-1 bg-white border-4 border-[#1A0A0E] shadow-[6px_6px_0_#1A0A0E] rounded-2xl p-7 md:order-first transition-transform hover:-translate-y-1 hover:shadow-[8px_8px_0_#1A0A0E]">
              <div className="font-gliker text-[40px] tracking-[3px] text-[#DD273E] mb-2 leading-none">2017–19</div>
          ...
          <div className="flex flex-col md:flex-row-reverse gap-6 md:gap-12 mb-12 items-start relative pl-12 md:pl-0">
            <div className="absolute left-[8px] top-[24px] md:static md:mt-7 w-6 h-6 bg-[#FCC803] border-[3px] border-[#1A0A0E] rounded-full shrink-0 shadow-[0_0_0_4px_#DD273E] z-10"></div>
            <div className="flex-1 bg-white border-4 border-[#1A0A0E] shadow-[6px_6px_0_#1A0A0E] rounded-2xl p-7 md:order-first transition-transform hover:-translate-y-1 hover:shadow-[8px_8px_0_#1A0A0E]">
              <div className="font-gliker text-[40px] tracking-[3px] text-[#DD273E] mb-2 leading-none">2019–22</div>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 mb-12 items-start relative pl-12 md:pl-0">
            <div className="absolute left-[8px] top-[24px] md:static md:mt-7 w-6 h-6 bg-[#FCC803] border-[3px] border-[#1A0A0E] rounded-full shrink-0 shadow-[0_0_0_4px_#DD273E] z-10"></div>
            <div className="flex-1 bg-white border-4 border-[#1A0A0E] shadow-[6px_6px_0_#1A0A0E] rounded-2xl p-7 md:order-first transition-transform hover:-translate-y-1 hover:shadow-[8px_8px_0_#1A0A0E]">
              <div className="font-gliker text-[40px] tracking-[3px] text-[#DD273E] mb-2 leading-none">2022–24</div>
          ...
          <div className="flex flex-col md:flex-row-reverse gap-6 md:gap-12 items-start relative pl-12 md:pl-0">
            <div className="absolute left-[8px] top-[24px] md:static md:mt-7 w-6 h-6 bg-[#FCC803] border-[3px] border-[#1A0A0E] rounded-full shrink-0 shadow-[0_0_0_4px_#DD273E] z-10"></div>
            <div className="flex-1 bg-white border-4 border-[#1A0A0E] shadow-[6px_6px_0_#1A0A0E] rounded-2xl p-7 md:order-first transition-transform hover:-translate-y-1 hover:shadow-[8px_8px_0_#1A0A0E]">
              <div className="font-gliker text-[40px] tracking-[3px] text-[#DD273E] mb-2 leading-none">2024–25</div>
      ...
      {/* ── CTA ── */}
      <section className="bg-[#DD273E] py-20 px-6 md:px-12 text-center relative overflow-hidden">
