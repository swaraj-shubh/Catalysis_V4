...
const MOBILE_BADGES: BadgeData[] = [
  { top: "5%",  left: "48%", label: "Pitch Perfect",   content: "STRATEGY TYPE", icon: "/about2/pitch.png",        primaryColor: "#F28B8B", secondaryColor: "#E05555" },
  ...
  { top: "68%", left: "68%", label: "Pitch Perfect",   content: "CREATIVE TYPE", icon: "/about2/ui-ux.png",        primaryColor: "#F28B8B", secondaryColor: "#E05555" },
];

const BADGES: BadgeData[] = [
  { top: "11%", left: "45%", label: "Pitch Perfect",   content: "STRATEGY TYPE", icon: "/about2/pitch.png",        primaryColor: "#F28B8B", secondaryColor: "#E05555" },
  ...
  { top: "63%", left: "58%", label: "Pitch Perfect",   content: "CREATIVE TYPE", icon: "/about2/ui-ux.png",        primaryColor: "#F28B8B", secondaryColor: "#E05555" },
];
