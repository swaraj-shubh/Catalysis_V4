...
const timeline: TimelineEvent[] = [
  ...
  { day: 1, date: "15/04", dayLabel: "TUESDAY",   title: "CODING RELAY",     venue: "DEV ARENA",             timeFrom: "13:30", timeTill: "15:30", description: "Tag-team coding under pressure. Pass the keyboard and never break the chain.",                  isEvent: true,  imagePath: "/pokemons/ditto.svg",     panelColor: "#FFD6EC",  hasRegister: true,  slug: "coding-relay" },
  ...
  { day: 2, date: "16/04", dayLabel: "WEDNESDAY", title: "DSA CHALLENGE",    venue: "ROOM 205",              timeFrom: "09:30", timeTill: "12:30", description: "Crack algorithms under a strict time limit. Efficiency is your only ally.",                      isEvent: true,  imagePath: "/pokemons/alakazam.svg",  panelColor: "#FFF3CD",  hasRegister: true,  slug: "dsa-challenge" },
  ...
  { day: 3, date: "17/04", dayLabel: "THURSDAY",  title: "PITCH EVENT",      venue: "ROOM 205",              timeFrom: "13:00", timeTill: "15:00", description: "Present your startup idea to judges. Impress with innovation, feasibility, and delivery.",      isEvent: true,  imagePath: "/pokemons/jigglypuff.svg",panelColor: "#FFD6F0",  hasRegister: true,  slug: "pitch-event"   },
